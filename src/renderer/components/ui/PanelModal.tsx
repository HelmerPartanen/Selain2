...
// Downloads, Settings). Provides: backdrop, genie-entrance animation,
// and Escape key dismissal. The caller owns all inner content.
//
// Z-index contract:
...
interface PanelModalProps {
  ...
  width: string
  height: string
  /** Extra classes applied to the panel surface (e.g. 'bg-white dark:bg-neutral-900') */
  className?: string
    ...
    <>
      ...
      <div className="fixed inset-0 z-[85] flex items-center justify-center pointer-events-none">
        <motion.div
          ...
          className={`rounded-3xl overflow-hidden shadow-2xl border border-gray-200/80 dark:border-neutral-700 [app-region:no-drag] pointer-events-auto ${className}`}
