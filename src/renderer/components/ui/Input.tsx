...
export const TextInput = forwardRef<HTMLInputElement, TextInputProps>(
  ({ invalid = false, inputSize = "md", className, ...props }, ref) => (
    <input
      ...
      className={cn(
        "w-full rounded-xl bg-black/[0.06] dark:bg-white/[0.08] border text-gray-800 dark:text-neutral-200 placeholder:text-gray-400 dark:placeholder:text-neutral-500 outline-none transition-all duration-200",
        "focus:border-blue-500/30 dark:focus:border-blue-400/30 focus-visible:ring-2 focus-visible:ring-blue-400/40 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-neutral-900",
        inputSize === "sm" ? "h-8 px-2.5 text-[12px]" : "h-10 px-3.5 text-[13px]",
        invalid
          ? "border-red-500/30 dark:border-red-400/30 ring-1 ring-red-500/50 dark:ring-red-400/50"
